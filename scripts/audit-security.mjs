...
const SAFE_SET_HTML_FILES = new Set([
  ...
  'src/components/ShorkiePanelHead.astro',
  ...
  'src/pages/lab.astro',
  'src/pages/games/2048.astro',
  'src/pages/games/bay-route.astro',
  ...
  'src/pages/games/minesweeper.astro',
...
const SAFE_INNER_HTML_FILES = new Set([
  ...
  'src/scripts/mambaStudio.ts',
  'src/scripts/mambaStudio.test.ts',

...
export const PAPERS: PaperEntry[] = [
  ...
  },
  {
    ...
    affiliation: 'InstaDeep AI, BioNeMo, & Google Cloud',
    ...
    summary:
      'A comprehensive suite of transformer foundation models for genomics scaling up to 2.5 billion parameters, trained across 3,202 genetically diverse human genomes and 850 multi-species reference genomes. Establishes a unified platform for zero-shot variant effect scoring, epigenomic track prediction, and regulatory motif discovery.',
    highlights: [
      'Scales transformer language models from 50M to 2.5B parameters across 9 trillion nucleotides from 3,202 human genomes + 850 species',
      'Deploys 6-mer tokenization and FlashAttention-2 with RoPE rotary embeddings for scalable sequence modeling up to 1 Mb context',
  ...
  },
  {
    ...
    shortTitle: 'Zoonomia Consortium Flagship',
    authors: ['Matthew J. Christmas', 'Irene M. Kaplow', 'Danielle L. Shapiro', 'Kerstin Lindblad-Toh', 'Elinor K. Karlsson'],
    affiliation: 'Broad Institute of MIT and Harvard & Uppsala University',
    venue: 'Science',
    year: 2023,
    doi: '10.1126/science.abn8197',
    doiUrl: 'https://doi.org/10.1126/science.abn8197',
    area: 'Comparative Genomics & Evolutionary Constraint',
    category: 'evolutionary-models',
    tag: 'Zoonomia Consortium · Science 2023',
    readingTime: '24 min read',
    summary:
      'Aligns 241 placental mammal whole-genome sequences spanning 100 million years of evolutionary divergence to quantify single-base evolutionary constraint across the human genome. Identifies 3.5 million ultra-conserved non-coding positions under intense purifying selection, substantially enriching for pathogenic mutations and complex disease heritability.',
    highlights: [
      'Generates 241-way whole-genome multiple sequence alignment across placental mammalian phylogeny spanning 100 million years',
      'Delineates 3.5 million ultra-conserved base pairs under strong negative purifying selection at single-nucleotide resolution',
      'Demonstrates that mammalian-constrained non-coding bases account for over 50% of complex disease heritability (S-LDSC)',
      'Identifies somatic cancer driver mutations and rare pathogenic non-coding variants in neurodevelopmental and psychiatric disorders',
    ],
    equations: [
      '\\text{phyloP}(i) = - \\log_{10} P(X_i \\mid \\text{Neutral Tree})',
      '\\tau^* = \\frac{M \\cdot h_g^2(C)}{M(C) \\cdot h_g^2}',
    ],

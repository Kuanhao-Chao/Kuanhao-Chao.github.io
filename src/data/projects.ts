...
export const projects: Project[] = [
  ...
  {
    slug: 'gffbase',
    title: 'GFFBase: high-performance genomic annotation engine',
    shortTitle: 'GFFBase',
    area: 'Genomic databases',
    year: '2024',
    status: 'Released',
    featured: true,
    tags: ['Genomics', 'Rust', 'DuckDB', 'PyArrow', 'Database'],
    summary:
      'A high-performance genomic-annotation engine combining a SIMD Rust parser, DuckDB columnar backend, and zero-copy PyArrow interface.',
    links: [
      { label: 'Docs', icon: 'book', href: 'https://khchao.com/gffbase/' },
      { label: 'Code', icon: 'code', href: 'https://github.com/Kuanhao-Chao/gffbase' },
    ],
  },
  {
    slug: 'splam',

...
export const software: SoftwareTool[] = [
  ...
  },
  {
    ...
    logo: 'gffbase',
    blurb:
      'High-performance genomic-annotation engine combining a SIMD Rust parser, DuckDB columnar backend, and zero-copy PyArrow interface.',
    license: LICENSE.apache,
    code: 'https://github.com/Kuanhao-Chao/gffbase',
    docs: 'https://khchao.com/gffbase/',
  },
  {
    name: 'Splam',
    date: '2024-08-15',

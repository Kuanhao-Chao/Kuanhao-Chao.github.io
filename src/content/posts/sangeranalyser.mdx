...
*Further reading: [sangerseqR](https://bioconductor.org/packages/sangerseqR), the R package for handling individual Sanger reads that sangeranalyseR builds on and extends.*

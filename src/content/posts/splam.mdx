...
abstract: >-
  This article summarizes Splam, a deep-learning splice-junction model that scores donor-acceptor pairs from local sequence and removes spurious spliced alignments from RNA-seq workflows. It explains the motivation for modeling junctions directly, the compact neural architecture, and the practical effect of cleaning alignments before transcript assembly.
date: 2024-08-15
category: summary

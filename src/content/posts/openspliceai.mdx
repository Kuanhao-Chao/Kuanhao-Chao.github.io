...
references:
  ...
  - text: 'Guo, C., Pleiss, G., Sun, Y., and Weinberger, K. Q. On calibration of modern neural networks. ICML (2017).'
...
I'd already built a splice-site model of my own, [Splam](https://doi.org/10.1186/s13059-024-03379-4), so I knew the problem space well. OpenSpliceAI was the natural next step. The goal was never a cleverer algorithm. It was to take the best splice-site model and make it open, modern, and retrainable by anyone — true to a motto I keep coming back to: build what you need, use what you build.

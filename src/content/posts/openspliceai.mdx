...
abstract: >-
  This article summarizes OpenSpliceAI, an efficient and modular PyTorch implementation of SpliceAI designed for retraining and variant-effect prediction across species. It explains the motivation for rebuilding SpliceAI, the software and modeling choices that make retraining practical, and the relationship between OpenSpliceAI and earlier splice-site prediction work.
date: 2025-06-01
category: summary

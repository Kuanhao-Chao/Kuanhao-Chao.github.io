...
abstract: >-
  This article summarizes the motivation and method behind LiftOn, a genome-annotation lift-over tool that combines DNA-based and protein-based alignments. It explains why DNA alignment and protein alignment fail in complementary ways, how LiftOn reconciles Liftoff and miniprot annotations with protein maximization, and why this improves annotation across assemblies and species.
date: 2025-02-01
category: summary

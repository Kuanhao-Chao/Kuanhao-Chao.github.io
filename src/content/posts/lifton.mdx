...
*Read the [paper in Genome Research](https://doi.org/10.1101/gr.279620.124), browse the [code](https://github.com/Kuanhao-Chao/LiftOn), or work through the [documentation](https://khchao.com/LiftOn/). LiftOn was built with Jakob M. Heinz, Celine Hoh, Alan Mao, Alaina Shumate, Mihaela Pertea, and Steven Salzberg at Johns Hopkins.*

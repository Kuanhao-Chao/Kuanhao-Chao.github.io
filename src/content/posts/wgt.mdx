...
abstract: >-
  This article summarizes the Wheeler Graph Toolkit (WGT), a software suite for generating, recognizing, and visualizing Wheeler graphs for pangenome indexing research. It explains why Wheeler graph recognition is computationally difficult, how WGT combines a renaming heuristic with permutation and SMT solvers, and how the toolkit makes graph-index structures practical to inspect and test.
date: 2023-07-14
category: summary

...
**Update — LiftOn 2.0.** I've since rebuilt LiftOn for whole-genome scale: it finishes full RefSeq genomes the previous release crashed on, lifts every gene-like feature type (pseudogenes, non-coding RNA genes, and more), and runs faster on a fraction of the memory. A twenty-dataset, four-way benchmark shows it stays the most accurate lift-over tool across the divergence ladder, with its lead over either method alone widening as species diverge. [Read the full story.](/posts/lifton-v2/)

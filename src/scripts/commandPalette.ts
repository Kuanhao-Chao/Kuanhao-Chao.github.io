...
const STATIC_ACTIONS: CommandItem[] = [
  ...
  },
  {
    id: 'act-bay-route',
    category: 'Actions',
    title: '🗺️ BayRoute: Bay Area Pathfinding Visualizer',
    subtitle: 'Dynamic step-by-step route search across the SF Bay Area (Dijkstra, A*, BFS, Greedy)',
    badge: 'Maps',
    href: '/games/bay-route/',
    keywords: [
      'bay',
      'route',
      'pathfinding',
  ...
  },
  {
    id: 'act-fun-lab',
    category: 'Actions',
    title: '✨ Lab for Fun: Interactive Biophysics Hub',
    subtitle: 'Explore 3D Chromatin Compaction and Sonic Genome DNA Synthesizer',
    badge: 'Lab',
    href: '/fun-lab/',
    keywords: ['fun', 'lab', 'chromatin', 'sonic', 'genome', 'playground', 'toy', 'interactive', 'audio', '3d'],
  },
  {
    id: 'act-shorkie-lab',
    category: 'Actions',
    title: '🧬 Shorkie Lab: Neural Genomics Hub',
    subtitle: 'Interactive interpretability for Shorkie expression & Shorkie_LM language models',
    badge: 'Models',
    href: '/shorkie-lab/',
    keywords: ['shorkie', 'shorkie_lm', 'lab', 'models', 'neural', 'deep learning', 'expression', 'language model', 'interpretability'],
  },
  {
    id: 'act-cell-lab',
    category: 'Actions',
    title: '🔬 Cell Lab: Cellular Automata Microscope',
    subtitle: 'In silico biological simulation of cellular homeostasis and proliferation',
    badge: 'Cells',
    href: '/lab',
    keywords: ['cell', 'lab', 'automata', 'microscope', 'cells', 'simulation', 'homeostasis'],
  },
  {
    id: 'act-sonic-genome',
    category: 'Actions',
    title: '🎵 Sonic Genome: DNA Audio Synthesizer',
    subtitle: 'Transform DNA sequences into real-time ambient music and soundscapes',
    badge: 'Audio',
    href: '/sonic-genome/',
    keywords: [
      'sonic',
  ...
  },
  {
    id: 'act-chromatin',
    category: 'Actions',
    title: '🧬 Open Chromatin Playground',
    subtitle: 'Scrub from the DNA duplex to a metaphase chromosome — five orders of magnitude',
    badge: '3D',
    href: '/chromatin/',
    keywords: [
      'chromatin',
...
const STATIC_NAV: CommandItem[] = [
  ...
  },
  {
    id: 'nav-shorkie-lab',
    category: 'Software',
    title: '🔬 Shorkie Lab: In-Browser Neural Interpretability Hub',
    subtitle: 'Compare Shorkie expression model and Shorkie_LM language model side-by-side',
    href: '/shorkie-lab/',
    keywords: [
      'shorkie',
      'lab',
  ...
  {
    id: 'nav-shorkie-expression',
    category: 'Software',
    title: '🧬 Shorkie Expression Model Playground',
    subtitle: 'Live feature attribution, occlusion mapping & layer traceback — 14.3M parameters',
    href: '/shorkie-lab/shorkie/',
    keywords: [
      'shorkie',
      'expression',
      'variant',
  ...
  },
  {
    id: 'nav-shorkie-lm',
    category: 'Software',
    title: '🔤 Shorkie_LM: Masked DNA Language Model Playground',
    subtitle: 'Zero-shot sequence constraint & information content across 165 fungal genomes',
    href: '/shorkie-lab/shorkie_lm/',
    keywords: [
      'shorkie',
      'language model',
      'lm',

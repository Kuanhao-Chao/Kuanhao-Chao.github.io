...
export default class Sketch {
  ...
  addObjects() {
    ...
    this.material = new THREE.ShaderMaterial({
      ...
      uniforms: {
        time: { value: 0 },
        uColor1: { value: new THREE.Color(0xffb441) },
        uColor2: { value: new THREE.Color(0xd59718) },
        uColor3: { value: new THREE.Color(0xf4d19c) },
...
new Sketch({
  dom: document.getElementById("dna_container")
});
